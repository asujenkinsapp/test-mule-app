...
-----------------------------------------------------------------
./src/test/resources/testmuleapp-functional-test-config.xml

Defines the Mule configuration for the TestmuleappTestCase.java.
...
artifactId=testmuleapp
description=Test Mule App
muleVersion=3.5.1
